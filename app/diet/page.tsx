...
const diets: Diet[] = [
  ...
  },
  {
    ...
    category: "Therapeutic",
    evidence: "Promising",
    summary: "A grain-free, lactose-free diet that allows only specific carbohydrates that are easily absorbed. A randomised controlled trial found it comparable to the Mediterranean diet for symptomatic remission in mild to moderate Crohn's disease, with emerging evidence in UC.",
    ...
    individual: "Most evidence exists for mild to moderate Crohn's disease. Emerging evidence in UC. May be less effective in severe disease. Individual food tolerances within the SCD vary — what works for one person may not work for another.",
  ...
  },
  {
    ...
    category: "Supportive",
    evidence: "Promising",
    summary: "A balanced whole-food diet rich in vegetables, fruits, legumes, whole grains, olive oil, and fish. Shown in a head-to-head randomised trial to achieve similar symptomatic remission rates to the SCD in mild to moderate Crohn's disease — and much easier to sustain long-term. Also associated with reduced UC flare frequency.",
    ...
    individual: "Generally well tolerated but individual food sensitivities still apply. Some people find high-fibre foods like legumes and raw vegetables difficult during active disease — cook vegetables thoroughly and introduce fibre gradually.",
  ...
  },
  {
    ...
    howLong: "A long-term lifestyle approach. Allow at least 3 months before fully assessing benefit on IBD symptoms.",
    ...
    worthKnowing: "Nutritional monitoring is important — particularly Vitamin B12, iron, zinc, and Vitamin D, which are commonly deficient in IBD and can be further affected by plant-based eating. Work with a dietitian.",
    individual: "Some people find high-fibre plant foods difficult during flares. During active disease, cooked and peeled vegetables are better tolerated than raw. A plant-based diet may be more suitable during remission.",
  ...
  },
  {
    ...
    category: "Supportive",
    evidence: "Promising",
    summary: "A diet that reduces fermentable carbohydrates that can cause gas, bloating, and diarrhoea. Originally developed for IBS, it has shown benefit for symptom management in both Crohn's and UC patients — particularly those with overlapping IBS symptoms.",
  ...
  },
  {
    ...
    category: "Supportive",
    evidence: "Promising",
    summary: "A diet that reduces the amount of undigested material (residue) passing through the colon. Widely used during UC flares to reduce stool frequency, urgency, and cramping while the bowel is inflamed and healing.",
    howItWorks: "By limiting high-fibre and hard-to-digest foods, the low residue diet reduces the volume and frequency of material moving through an inflamed colon. This can ease urgency, cramping, and the number of bowel movements per day — giving the colon some relief during active disease.",
    howLong: "Short-term only — typically used during active flares for 2 to 6 weeks. It is not intended as a long-term approach as it restricts many nutritious foods. Once symptoms settle, food variety should be gradually reintroduced.",
    reintroduction: "Reintroduce higher-fibre foods one at a time as symptoms improve. Start with well-cooked, peeled vegetables before moving to raw vegetables, skins, and wholegrains. Move at whatever pace feels comfortable.",
    worthKnowing: "A low residue diet manages symptoms — it does not treat the underlying inflammation. It should always be used alongside your prescribed medical treatment, not instead of it. Nutritional gaps are possible on this diet, so dietitian support is recommended if following it for more than 2 weeks.",
    individual: "Very effective for some people during UC flares; others find it makes little difference. Tolerance of specific foods varies — use this as a general framework and adjust based on your own response. Discuss with your gastroenterologist or dietitian before starting.",
  ...
  },
  {
    ...
    worthKnowing: "The elimination phase is very restrictive and nutritional deficiencies are a real risk if not carefully managed. Some people feel significantly better; others find it unsustainable. Limited formal clinical trial evidence in IBD specifically.",
...
const recipes: Recipe[] = [
  {
    ...
    evidence: "Anecdotal",
    description: "A soft, easily digestible rice porridge with poached chicken. One of the most universally tolerated comfort foods reported by people with IBD during flares. Warm, nourishing and gentle on the gut.",
    ingredients: ["1 cup white rice","6 cups low-sodium chicken broth (homemade or additive-free)","200g chicken breast","1 tsp fresh ginger, finely grated","Salt to taste","Spring onion tips (green part only — low FODMAP) to serve"],
    method: ["Place rice and broth in a large pot and bring to a gentle boil","Add chicken breast whole to the pot","Reduce heat and simmer uncovered for 45 to 60 minutes, stirring occasionally, until rice breaks down into a thick porridge","Remove chicken, shred finely and return to pot","Add ginger and season gently with salt","Serve warm — small portions are easier to tolerate during a flare"],
  ...
  },
  {
    ...
    evidence: "Anecdotal",
    description: "Soft steamed salmon with smooth pumpkin mash. Salmon provides easily absorbed protein and omega-3 fatty acids from whole food sources, which are generally better tolerated than supplements in IBD. ⚠️ Butternut pumpkin may not suit everyone in larger amounts — see the recipe disclaimer above.",
    ingredients: ["150g salmon fillet, skin removed","300g butternut pumpkin, peeled and cubed","1 tbsp olive oil","Salt to taste","Fresh lemon juice"],
    method: ["Steam or boil pumpkin until very soft — approximately 15 minutes","Mash pumpkin with olive oil and salt until completely smooth — no lumps","Steam salmon fillet for 8 to 10 minutes until cooked through and flaky","Serve salmon on top of pumpkin mash with a squeeze of fresh lemon"],
  ...
  },
  {
    ...
    evidence: "Anecdotal",
    description: "A slow-simmered broth rich in gelatine, collagen, and minerals. Widely reported by IBD patients as soothing during flares and supportive of gut lining health. Easy to sip and requires minimal digestive effort.",
    ingredients: ["1kg chicken carcass or beef bones (ask your butcher)","2 tbsp apple cider vinegar","2 carrots, roughly chopped","2 celery stalks, roughly chopped","1 bay leaf","Enough cold water to cover"],
    method: ["Place bones in a large pot and cover with cold water","Add apple cider vinegar and let sit for 30 minutes — this helps draw minerals from the bones","Bring to a boil, then reduce to the lowest possible simmer","Simmer for 12 to 24 hours for chicken bones, 24 to 48 hours for beef bones","Strain through a fine mesh sieve and discard solids","Season lightly with salt and sip warm, or use as a base for soups"],
  ...
  },
  {
    ...
    ingredients: ["1 ripe banana (frozen for a thicker texture)","100g cooked and cooled pumpkin","200ml lactose-free milk or coconut milk","1 tsp pure maple syrup (optional)","Pinch of cinnamon"],
    method: ["Add all ingredients to a blender","Blend until completely smooth","Add extra milk if needed to reach desired consistency","Serve immediately at room temperature — cold drinks can aggravate cramping for some people"],
  ...
  },
  {
    ...
    ingredients: ["400g chicken thigh, diced","2 medium carrots, sliced","2 zucchini, sliced","1 cup spinach leaves","1 litre additive-free chicken stock","1 tsp turmeric powder","½ tsp freshly ground black pepper","1 tbsp olive oil","Salt to taste","Fresh lemon juice to serve"],
    method: ["Heat olive oil in a large pot over medium heat","Add chicken and cook until sealed — about 5 minutes","Add carrots and stock and bring to a gentle simmer","Add turmeric and black pepper and stir well","Simmer for 20 minutes until carrots are tender","Add zucchini and spinach in the last 5 minutes","Season with salt and finish with fresh lemon juice"],
  ...
  },
  {
    ...
    ingredients: ["2 salmon fillets","1 red capsicum, sliced","1 zucchini, sliced","1 cup cherry tomatoes","2 tbsp olive oil","1 tsp dried oregano","Salt and pepper to taste","Fresh lemon to serve"],
    method: ["Preheat oven to 200°C","Toss vegetables in olive oil, oregano, salt and pepper","Spread vegetables on a lined baking tray and roast for 15 minutes","Place salmon fillets on top of vegetables","Return to oven and bake for a further 12 to 15 minutes until salmon is cooked through","Serve with fresh lemon"],
  ...
  },
  {
    ...
    ingredients: ["½ cup rolled oats","¾ cup lactose-free milk or oat milk","1 tbsp chia seeds","1 tbsp pure maple syrup","½ banana, sliced","A small handful of blueberries"],
    method: ["Combine oats, milk and chia seeds in a jar or container","Stir well, seal and refrigerate overnight","In the morning, stir again and add a little extra milk if too thick","Top with banana and blueberries","Add maple syrup to taste"],
  ...
  },
  {
    ...
    evidence: "Anecdotal",
    description: "A simple, versatile protein-rich meal that suits almost every diet approach for IBD. Chicken thighs are more nutrient dense and forgiving to cook than breast meat.",
    ingredients: ["4 chicken thighs, bone-in skin-on","2 tbsp olive oil","Juice of 1 lemon","1 tsp dried thyme","1 tsp dried rosemary","Salt and pepper to taste"],
    method: ["Preheat oven to 200°C","Mix olive oil, lemon juice, herbs, salt and pepper in a bowl","Coat chicken thighs in the mixture","Place in a baking dish skin side up","Bake for 35 to 40 minutes until skin is golden and juices run clear","Rest for 5 minutes before serving"],
...
const sharedDifficultFoods = [
  ...
  { category: "Dairy — lactose vs casein sensitivity", detail: "Not all dairy reactions are the same. Lactose intolerance is more common in Crohn's patients with small bowel involvement, and can occur in UC too. However some people continue to react to dairy even after switching to lactose-free products — this may indicate casein sensitivity. A2 milk (available in Australian supermarkets) and goat or sheep dairy contain a different casein type that some people tolerate better. Discuss with your dietitian before eliminating dairy entirely." },
  ...
  { category: "Alcohol", detail: "Alcohol increases intestinal permeability and can directly trigger flares in both Crohn's and UC. Even small amounts affect some individuals significantly." },
...
const crohnsDifficultFoods = [
  { category: "High-fat foods (Crohn's specific)", detail: "Fat malabsorption is common in Crohn's disease — particularly when the small bowel is affected. Fatty or fried foods can cause diarrhoea and cramping in some people. Healthy fats from olive oil and oily fish are generally better tolerated than animal or fried fats." },
];

const ucDifficultFoods = [
  { category: "High-fibre foods during flares (UC specific)", detail: "During a UC flare, high-fibre foods — wholegrains, raw vegetables, legumes, nuts and seeds — can worsen urgency and stool frequency. A temporary low residue approach (see Low Residue Diet above) can help manage symptoms while the colon heals. Fibre is important long-term and should be gradually reintroduced once symptoms settle." },
  { category: "Caffeine (UC specific)", detail: "Caffeine stimulates bowel contractions and can worsen urgency and frequency during a UC flare. Coffee, tea, energy drinks and cola are common triggers. Tolerance varies — some people manage small amounts fine, others need to avoid caffeine entirely during active disease." },
];
...
export default function Diet() {
  ...
  const toggleDiet = (name: string) => setExpandedDiets((prev) => ({ ...prev, [name]: !prev[name] }));
  const toggleRecipe = (name: string) => setExpandedRecipes((prev) => ({ ...prev, [name]: !prev[name] }));

  const filteredDiets = diets.filter((d) => {
    const conditionMatch = activeCondition === "All" || d.condition === activeCondition || d.condition === "Both";
    const categoryMatch = activeCategory === "All" || d.category === activeCategory;
    return conditionMatch && categoryMatch;
  });

  const filteredRecipes = activeRecipeCategory === "All" ? recipes : recipes.filter((r) => r.category === activeRecipeCategory);

  const difficultFoods = [
    ...sharedDifficultFoods,
    ...(activeCondition === "Crohn's" ? crohnsDifficultFoods : []),
    ...(activeCondition === "UC" ? ucDifficultFoods : []),
    ...(activeCondition === "All" ? [...crohnsDifficultFoods, ...ucDifficultFoods] : []),
  ];
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-page)" }}>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-6">
        <div className="flex flex-wrap gap-2">
          {(Object.keys(evidenceColors) as EvidenceType[]).map((label) => (
            <span key={label} className="px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1.5" style={{ backgroundColor: evidenceColors[label].bg, color: evidenceColors[label].text }}>
              <span style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: evidenceColors[label].dot, display: "inline-block", flexShrink: 0 }} />
              {label}
            </span>
          ))}
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-6">
        ...
        <div className="flex gap-0 mb-6 border-b" style={{ borderColor: "var(--border-color)" }}>
          {(["All", "Crohn's", "UC"] as const).map((cond) => (
            <button key={cond} onClick={() => setActiveCondition(cond)} className="px-5 py-2 text-sm font-medium transition-all"
              style={{ color: activeCondition === cond ? "var(--nav-bg)" : "var(--text-secondary)", borderBottom: activeCondition === cond ? "2px solid var(--nav-bg)" : "2px solid transparent", marginBottom: "-1px", backgroundColor: "transparent" }}>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          {(["All", "Therapeutic", "Supportive", "Experimental"] as const).map((cat) => (
            <button key={cat} onClick={() => setActiveCategory(cat)} className="px-5 py-2 rounded-full text-sm font-medium transition-all"
              style={{ backgroundColor: activeCategory === cat ? "var(--nav-bg)" : "var(--bg-card)", color: activeCategory === cat ? "#ffffff" : "var(--text-primary)", border: "1px solid var(--text-primary)" }}>
              {cat}
            </button>
          ))}
        </div>
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {filteredDiets.map((diet) => {
            ...
            return (
              <div key={diet.name} className="rounded-2xl p-6 border shadow-sm" style={{ backgroundColor: "var(--bg-card)", borderColor: "var(--border-color)" }}>
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="text-xs font-medium px-3 py-1 rounded-full flex items-center gap-1.5" style={{ backgroundColor: evidenceColors[diet.evidence].bg, color: evidenceColors[diet.evidence].text }}>
                    <span style={{ width: 7, height: 7, borderRadius: "50%", backgroundColor: evidenceColors[diet.evidence].dot, display: "inline-block", flexShrink: 0 }} />
                    {diet.evidence}
                  </span>
                ...
                <button onClick={() => toggleDiet(diet.name)} className="text-xs font-medium flex items-center gap-1" style={{ color: "#2E8B6A" }}>
                ...
                {isExpanded && (
                  <div className="mt-3 rounded-xl px-4 py-4 text-xs leading-relaxed space-y-3" style={{ backgroundColor: "var(--bg-accent)", color: "var(--text-primary)" }}>
                    <div><p className="font-semibold mb-1">How it works</p><p>{diet.howItWorks}</p></div>
                    <div><p className="font-semibold mb-1">How long to try it</p><p>{diet.howLong}</p></div>
                    <div><p className="font-semibold mb-1">Reintroducing foods</p><p>{diet.reintroduction}</p></div>
                  </div>
                )}
              </div>
            );
      ...
      <div className="max-w-6xl mx-auto px-6 pb-20">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          {(["All", "Flare-friendly", "Remission-friendly"] as const).map((cat) => (
            <button key={cat} onClick={() => setActiveRecipeCategory(cat)} className="px-5 py-2 rounded-full text-sm font-medium transition-all"
              style={{ backgroundColor: activeRecipeCategory === cat ? "var(--nav-bg)" : "var(--bg-card)", color: activeRecipeCategory === cat ? "#ffffff" : "var(--text-primary)", border: "1px solid var(--text-primary)" }}>
              {cat}
            </button>
          ))}
        </div>
        <div className="grid md:grid-cols-2 gap-6">
          {filteredRecipes.map((recipe) => {
            ...
            return (
              <div key={recipe.name} className="rounded-2xl p-6 border shadow-sm" style={{ backgroundColor: "var(--bg-card)", borderColor: "var(--border-color)" }}>
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="text-xs font-medium px-3 py-1 rounded-full" style={{ backgroundColor: recipe.category === "Flare-friendly" ? "#F5EEF8" : "#D4EDE4", color: recipe.category === "Flare-friendly" ? "#6C3483" : "#1B4F3A" }}>{recipe.category}</span>
                  <span className="text-xs font-medium px-3 py-1 rounded-full flex items-center gap-1.5" style={{ backgroundColor: evidenceColors[recipe.evidence].bg, color: evidenceColors[recipe.evidence].text }}>
                    <span style={{ width: 7, height: 7, borderRadius: "50%", backgroundColor: evidenceColors[recipe.evidence].dot, display: "inline-block", flexShrink: 0 }} />
                    {recipe.evidence}
                  </span>
                </div>
                <h3 className="text-lg font-semibold mb-1" style={{ color: "var(--text-primary)" }}>{recipe.name}</h3>
                <div className="flex flex-wrap gap-1 mb-3">
                  {recipe.suitsDiets.map((d) => (<span key={d} className="text-xs px-2 py-0.5 rounded-full" style={{ backgroundColor: "#EEF2FF", color: "#4338CA" }}>{d}</span>))}
                </div>
                <p className="text-sm leading-relaxed mb-3" style={{ color: "var(--text-secondary)" }}>{recipe.description}</p>
                <div className="rounded-xl px-4 py-3 mb-3" style={{ backgroundColor: "var(--bg-page)" }}>
                  <p className="text-xs font-semibold mb-1" style={{ color: "var(--text-primary)" }}>💡 Tip</p>
                  <p className="text-xs leading-relaxed" style={{ color: "var(--text-secondary)" }}>{recipe.tip}</p>
                </div>
                <button onClick={() => toggleRecipe(recipe.name)} className="text-xs font-medium flex items-center gap-1" style={{ color: "#2E8B6A" }}>
      ...
      <footer className="border-t py-8 text-center" style={{ borderColor: "var(--border-color)", backgroundColor: "var(--footer-bg)" }}>
        ...
        <p className="text-xs mt-2" style={{ color: "var(--text-muted)" }}>Always consult your gastroenterologist and an Accredited Practising Dietitian before making significant dietary changes.</p>
      </footer>
    </div>
  );
}